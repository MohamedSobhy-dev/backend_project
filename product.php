...
<?php
  ...
  $res_category = $conn->query($selectCategory);
...
?>
							<li class="p-t-4">
								<a href="?id=<?= $cat['id']; ?>" class="s-text13">
									<?= $cat['name'];?>
								</a>
							</li>
<?php } ?>
    ...
    <?php 
			if(!isset($_GET['id'])){
				...
				$id = $_GET['id'];
				$selectProduct ="SELECT * FROM products WHERE category = '$id'";
			}
				$res_product = $conn->query($selectProduct);
				foreach ($res_product as $pro) {
	?>
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							<!-- Block2 -->
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="admin/images/<?= $pro['cover']; ?>" alt="IMG-PRODUCT">
